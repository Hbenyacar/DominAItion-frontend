...
<Box
  sx={{
    width: "250px",
    maxHeight: "250px",      // maximum height of the entire box
    backgroundColor: "rgba(0,0,0,0.3)",
    borderRadius: "12px",
    padding: 2,
    overflowY: "auto",       // scrollable when content exceeds maxHeight
    marginBottom: 2,
  }}
>
  {/* Players */}
  ...
  <Box
    sx={{
      maxHeight: "200px",    // fixed height for the players list
  ...
  <Box
    sx={{
      maxHeight: "200px",   // fixed height for the spectators list
      overflowY: "auto",    // scrollable
      mt: 1,
    }}
  >
